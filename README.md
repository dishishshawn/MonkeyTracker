...
- Independent monkey fur and face colors, including blue and pink fur choices
...
ignored `.env` activates the real account, invite, and realtime flow. Fresh
clones remain local-first until configured; see
